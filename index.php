    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">DEEPIKA S</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 6369767282</h4>
		<h4 style="font-family:'typo' ">deeepikasekar222@gmail.com</h4>
		<h4 style="font-family:'typo' ">M.Kumarasamy College Of Engineering</h4></div></div>
		</p>
      </div>
